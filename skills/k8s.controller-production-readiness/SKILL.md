...
Issues that will cause operational blindness, untested failure modes, or missing coverage for critical paths. Each issue includes:
...
Issues that indicate poor practices or gaps in test/observability coverage. Same format as critical.
...
Improvements that would increase test quality, observability, or operational confidence. Same format as critical.
